...
<body>
  ...
  <div class="container">
   ...
   <div id="alert">
      ...
      <i class='fa fa-caret-square-o-right' style='font-size:20px; margin-top:10px; color:yellow'></i>
      <i class="fa fa-angle-double-right" style="font-size:20px;color:yellow"></i></a>
